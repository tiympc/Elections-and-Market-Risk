...
coefficients(consumerGoodsBeta_versus_winPercent)[1],
coefficients(realEstateBeta_versus_winPercent)[1],
coefficients(telecommunicationsBeta_versus_winPercent)[1],
coefficients(utilitiesBeta_versus_winPercent)[1],
coefficients(technologyBeta_versus_winPercent)[1],
coefficients(industrialBeta_versus_winPercent)[1],
coefficients(financialBeta_versus_winPercent)[1],
coefficients(energyBeta_versus_winPercent)[1],
coefficients(consumerDiscretionaryBeta_versus_winPercent)[1],
coefficients(healthCareBeta_versus_winPercent)[1],
coefficients(materialsBeta_versus_winPercent)[1]
)

landslideDataSlopes <- c(
coefficients(consumerGoodsBeta_versus_winPercent)[2],
coefficients(realEstateBeta_versus_winPercent)[2],
coefficients(telecommunicationsBeta_versus_winPercent)[2],
coefficients(utilitiesBeta_versus_winPercent)[2],
coefficients(technologyBeta_versus_winPercent)[2],
coefficients(industrialBeta_versus_winPercent)[2],
coefficients(financialBeta_versus_winPercent)[2],
coefficients(energyBeta_versus_winPercent)[2],
coefficients(consumerDiscretionaryBeta_versus_winPercent)[2],
coefficients(healthCareBeta_versus_winPercent)[2],
coefficients(materialsBeta_versus_winPercent)[2]
)

landslideTable <- data.frame(sectors, landslideDataIntercepts, landslideDataSlopes)

landslideTable

energyLandslideDataPlot
technologyLandslideDataPlot
healthCareLandslideDataPlot
realEstateLandslideDataPlot
