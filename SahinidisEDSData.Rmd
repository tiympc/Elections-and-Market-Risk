...
values_consumerGoodsBeta_All <- c(beta_consumerGoods2000_90, beta_consumerGoods2004_90, beta_consumerGoods2008_90, beta_consumerGoods2012_90, beta_consumerGoods2016_90, beta_consumerGoods2000_Post, beta_consumerGoods2004_Post, beta_consumerGoods2008_Post, beta_consumerGoods2012_Post, beta_consumerGoods2016_Post)
# Turn x-axis and y-axis data into a data frame to use for ggplot2.
betas_consumerGoods_Aggregate <- data.frame(electionYears, values_consumerGoodsBeta_Post, values_consumerGoodsBeta_All)

mid = 0 # Used to create multiple gradients in one plot. Since beta can be negative or positive, the a beta of 0 means no market risk whatsoever. Thus, the midpoint is 0.

betasPlot_consumerGoods_Aggregate <- ggplot(data = betas_consumerGoods_Post, aes(x = electionYears, y = values_consumerGoodsBeta_Post, group = 1)) +
...
values_telecommunicationsBeta_All <- c(beta_telecommunications2000_90, beta_telecommunications2004_90, beta_telecommunications2008_90, beta_telecommunications2012_90, beta_telecommunications2016_90, beta_telecommunications2000_Post, beta_telecommunications2004_Post, beta_telecommunications2008_Post, beta_telecommunications2012_Post, beta_telecommunications2016_Post)
betas_telecommunications_Aggregate <- data.frame(electionYears, values_telecommunicationsBeta_Post, values_telecommunicationsBeta_All)
betasPlot_telecommunications_Aggregate <- ggplot(data = betas_telecommunications_Post, aes(x = electionYears, y = values_telecommunicationsBeta_Post, group = 1)) +
...
values_utilitiesBeta_All <- c(beta_utilities2000_90, beta_utilities2004_90, beta_utilities2008_90, beta_utilities2012_90, beta_utilities2016_90, beta_utilities2000_Post, beta_utilities2004_Post, beta_utilities2008_Post, beta_utilities2012_Post, beta_utilities2016_Post)
betas_utilities_Aggregate <- data.frame(electionYears, values_utilitiesBeta_Post, values_utilitiesBeta_All)
betasPlot_utilities_Aggregate <- ggplot(data = betas_utilities_Post, aes(x = electionYears, y = values_utilitiesBeta_Post, group = 1)) +
...
values_technologyBeta_All <- c(beta_technology2000_90, beta_technology2004_90, beta_technology2008_90, beta_technology2012_90, beta_technology2016_90, beta_technology2000_Post, beta_technology2004_Post, beta_technology2008_Post, beta_technology2012_Post, beta_technology2016_Post)
betas_technology_Aggregate <- data.frame(electionYears, values_technologyBeta_Post, values_technologyBeta_All)
betasPlot_technology_Aggregate <- ggplot(data = betas_technology_Post, aes(x = electionYears, y = values_technologyBeta_Post, group = 1)) +
...
values_industrialBeta_All <- c(beta_industrial2000_90, beta_industrial2004_90, beta_industrial2008_90, beta_industrial2012_90, beta_industrial2016_90, beta_industrial2000_Post, beta_industrial2004_Post, beta_industrial2008_Post, beta_industrial2012_Post, beta_industrial2016_Post)
betas_industrial_Aggregate <- data.frame(electionYears, values_industrialBeta_Post, values_industrialBeta_All)
betasPlot_industrial_Aggregate <- ggplot(data = betas_industrial_Post, aes(x = electionYears, y = values_industrialBeta_Post, group = 1)) +
...
values_financialBeta_All <- c(beta_financial2000_90, beta_financial2004_90, beta_financial2008_90, beta_financial2012_90, beta_financial2016_90, beta_financial2000_Post, beta_financial2004_Post, beta_financial2008_Post, beta_financial2012_Post, beta_financial2016_Post)
betas_financial_Aggregate <- data.frame(electionYears, values_financialBeta_Post, values_financialBeta_All)
betasPlot_financial_Aggregate <- ggplot(data = betas_financial_Post, aes(x = electionYears, y = values_financialBeta_Post, group = 1)) +
...
values_energyBeta_All <- c(beta_energy2000_90, beta_energy2004_90, beta_energy2008_90, beta_energy2012_90, beta_energy2016_90, beta_energy2000_Post, beta_energy2004_Post, beta_energy2008_Post, beta_energy2012_Post, beta_energy2016_Post)
betas_energy_Aggregate <- data.frame(electionYears, values_energyBeta_Post, values_energyBeta_All)
betasPlot_energy_Aggregate <- ggplot(data = betas_energy_Post, aes(x = electionYears, y = values_energyBeta_Post, group = 1)) +
...
values_consumerDiscretionaryBeta_All <- c(beta_consumerDiscretionary2000_90, beta_consumerDiscretionary2004_90, beta_consumerDiscretionary2008_90, beta_consumerDiscretionary2012_90, beta_consumerDiscretionary2016_90, beta_consumerDiscretionary2000_Post, beta_consumerDiscretionary2004_Post, beta_consumerDiscretionary2008_Post, beta_consumerDiscretionary2012_Post, beta_consumerDiscretionary2016_Post)
betas_consumerDiscretionary_Aggregate <- data.frame(electionYears, values_consumerDiscretionaryBeta_Post, values_consumerDiscretionaryBeta_All)
betasPlot_consumerDiscretionary_Aggregate <- ggplot(data = betas_consumerDiscretionary_Post, aes(x = electionYears, y = values_consumerDiscretionaryBeta_Post, group = 1)) +
...
values_healthCareBeta_All <- c(beta_healthCare2000_90, beta_healthCare2004_90, beta_healthCare2008_90, beta_healthCare2012_90, beta_healthCare2016_90, beta_healthCare2000_Post, beta_healthCare2004_Post, beta_healthCare2008_Post, beta_healthCare2012_Post, beta_healthCare2016_Post)
betas_healthCare_Aggregate <- data.frame(electionYears, values_healthCareBeta_Post, values_healthCareBeta_All)
betasPlot_healthCare_Aggregate <- ggplot(data = betas_healthCare_Post, aes(x = electionYears, y = values_healthCareBeta_Post, group = 1)) +
...
values_materialsBeta_All <- c(beta_materials2000_90, beta_materials2004_90, beta_materials2008_90, beta_materials2012_90, beta_materials2016_90, beta_materials2000_Post, beta_materials2004_Post, beta_materials2008_Post, beta_materials2012_Post, beta_materials2016_Post)
betas_materials_Post <- data.frame(electionYears, values_materialsBeta_90, values_materialsBeta_Post, values_materialsBeta_All)
betasPlot_materials_Aggregate <- ggplot(data = betas_materials_Post, aes(x = electionYears, y = values_materialsBeta_All, group = 1)) +
...
consumerGoodsDifOfPreAndPost_versus_winPercentPlot
...
telecommunicationsDifOfPreAndPost_versus_winPercentPlot
...
utilitiesDifOfPreAndPost_versus_winPercentPlot
...
industrialDifOfPreAndPost_versus_winPercentPlot
...
financialDifOfPreAndPost_versus_winPercentPlot
...
consumerDiscretionaryDifOfPreAndPost_versus_winPercentPlot
...
materialsDifOfPreAndPost_versus_winPercentPlot
